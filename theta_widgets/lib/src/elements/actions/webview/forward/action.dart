...
class TAWebViewGoForward extends TetaAction {
  TAWebViewGoForward({
  ...
  TAWebViewGoForward.fromJson(
    final Map<String, dynamic> json,
  ) : super(
          params: TAWebViewGoForwardParams.fromJson(
  ...
  @override
  TAWebViewGoForwardParams get params =>
      super.params as TAWebViewGoForwardParams;

  @override
  TetaActionType get type => TetaActionType.webViewGoForward;
