...
class TASupabaseOnAllParams implements TetaActionParams {
  const TASupabaseOnAllParams({
    required this.supabaseFrom,
    required this.stateName,
    required this.supabaseData,
  });

  const TASupabaseOnAllParams.empty()
      : supabaseFrom = null,
        stateName = null,
        supabaseData = const [];

  TASupabaseOnAllParams.fromJson(final Map<String, dynamic> json)
