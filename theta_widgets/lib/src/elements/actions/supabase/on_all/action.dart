...
class TASupabaseOnAll extends TetaAction {
  TASupabaseOnAll({
  ...
  TASupabaseOnAll.fromJson(
    final Map<String, dynamic> json,
  ) : super(
          params: TASupabaseOnAllParams.fromJson(
  ...
  @override
  TASupabaseOnAllParams get params => super.params as TASupabaseOnAllParams;

  @override
  TetaActionType get type => TetaActionType.supabaseOnAll;
