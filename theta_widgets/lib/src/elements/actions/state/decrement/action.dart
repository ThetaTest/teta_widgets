...
class TAStateDecrement extends TetaAction {
  TAStateDecrement({
  ...
  TAStateDecrement.fromJson(
    final Map<String, dynamic> json,
  ) : super(
          params: TAStateDecrementParams.fromJson(
  ...
  @override
  TAStateDecrementParams get params => super.params as TAStateDecrementParams;

  @override
  TetaActionType get type => TetaActionType.stateDecrement;
