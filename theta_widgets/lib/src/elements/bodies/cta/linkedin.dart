...
import 'package:theta_widgets/src/elements/code/templates/linkedin.dart';
// Project imports:
...
import 'package:theta_widgets/src/elements/widgets/cta/linkedin.dart';

const _globalType = NType.loginWithLinkedin;

/// Instrict State of Linkedin Login
final loginLinkedinIntrinsicStates = IntrinsicStates(
...
/// Linkedin Login's body
class LoginWithLinkedinBody extends NodeBody {
  @override
  ...
  Future<String> toCode(
    ...
    final int? loop,
      ...
      CS.defaultWidgets(
        ...
        node,
        pageId,
        LoginLinkedinCodeTemplate.toCode(
          pageId,
          context,
          node,
          child,
