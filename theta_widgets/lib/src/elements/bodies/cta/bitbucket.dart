...
import 'package:theta_widgets/src/elements/code/templates/bitbucket.dart';
// Project imports:
...
import 'package:theta_widgets/src/elements/widgets/cta/bitbucket.dart';

const _globalType = NType.loginWithBitBucket;

/// Instrict State of BitBucket Login
final loginBitBucketIntrinsicStates = IntrinsicStates(
...
/// BitBucket Login's body
class LoginWithBitBucketBody extends NodeBody {
  @override
  ...
  Future<String> toCode(
    ...
    final int? loop,
      ...
      CS.defaultWidgets(
        ...
        node,
        pageId,
        LoginBitBucketCodeTemplate.toCode(
