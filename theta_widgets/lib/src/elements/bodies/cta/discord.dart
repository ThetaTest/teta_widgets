...
import 'package:theta_widgets/src/elements/code/templates/discord.dart';
// Project imports:
...
import 'package:theta_widgets/src/elements/widgets/cta/discord.dart';

const _globalType = NType.loginWithDiscord;

/// Instrict State of Discord Login
final loginDiscordIntrinsicStates = IntrinsicStates(
...
/// Discord Login's body
class LoginWithDiscordBody extends NodeBody {
  @override
