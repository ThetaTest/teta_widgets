...
const globalType = "ShpPrd";
const global_name = "Shopify Product";

class ShpPrdIntrinsicStates extends IntrinsicStates {
  final String nodeIcon = "w_icons/product_by_id.png";
...
class NShopifyProduct extends CNode {
  ...
  static NShopifyProduct fromJson(
    Map<String, dynamic> doc,
    String prjId,
    String pageId,
    BuildContext context,
  ) {
    return NShopifyProduct(
      nid: doc[DBKeys.id],
