...
import 'package:mobile_editor/src/elements/widgets/shopify/shopify_orders.dart';
import 'package:mobile_editor/src/models/dataset.dart';
import 'package:mobile_editor/src/models/variable.dart';
import 'package:uuid/uuid.dart';

const globalType = "ShpPrdsOrders";
const global_name = "Shopify Orders";

class ShpPrdsOrdersIntrinsicStates extends IntrinsicStates {
  final String nodeIcon = "w_icons/shp_orders_list.png";
...
class NShopifyOrders extends CNode {
  ...
  static NShopifyOrders fromJson(
    Map<String, dynamic> doc,
    String prjId,
    String pageId,
    BuildContext context,
  ) {
    return NShopifyOrders(
      nid: doc[DBKeys.id],
  ...
  @override
  String toString() => 'ShpPrdsOrders { nid: $nid, child: $child }';
