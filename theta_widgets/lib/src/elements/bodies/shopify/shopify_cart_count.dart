...
import 'package:mobile_editor/src/elements/widgets/shopify/shopify_cart_count.dart';
import 'package:mobile_editor/src/models/dataset.dart';
import 'package:mobile_editor/src/models/variable.dart';
import 'package:uuid/uuid.dart';

const globalType = "ShpCartCount";
const global_name = "Shopify Cart Count";

class ShpCartIntrinsicStates extends IntrinsicStates {
...
class NShopifyCartCount extends CNode {
  ...
  static NShopifyCartCount fromJson(
    Map<String, dynamic> doc,
    String prjId,
    String pageId,
    BuildContext context,
  ) {
    return NShopifyCartCount(
      nid: doc[DBKeys.id],
