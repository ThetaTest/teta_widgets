...
// Project imports:
import 'package:theta_widgets/src/elements/code/templates/teta_store/teta_store_transactions_builder_template.dart';
...
import 'package:theta_widgets/src/elements/widgets/teta_store/teta_store_transactions_builder.dart';

const _globalType = NType.tetaStoreTransactionsBuilder;

/// Intrinsic States of ListView Builder
final tetaStoreTransactionsBuilder = IntrinsicStates(
...
class TetaStoreTransactionsBuilderBody extends NodeBody {
  @override
  ...
  Future<String> toCode(
    ...
    final int? loop,
      ...
      CS.defaultWidgets(
        ...
        node,
        pageId,
        TetaStoreTransactionsBuilderCodeTemplate.toCode(context, this, child),
        loop ?? 0,
      );
}
