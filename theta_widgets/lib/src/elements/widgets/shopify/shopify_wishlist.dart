...
import 'package:mobile_editor/src/cubits/local_shopify_whishlist/cubit.dart';
...
class WShopifyWishlist extends StatefulWidget {
  final CNode node;
  final String? nid;
  final String? parent;
  final CNode? child;
  ...
  @override
  _WShopifyWishlistState createState() => _WShopifyWishlistState();
}

class _WShopifyWishlistState extends State<WShopifyWishlist> {
  ...
  Widget body(BuildContext context) {
    return BlocBuilder<LocalShopifyWishlist, List<String>>(
