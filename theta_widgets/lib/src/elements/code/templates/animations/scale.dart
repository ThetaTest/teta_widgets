...
class ScaleCodeTemplate {
  ...
  ''';
    ...
    if (res) {
      ...
      final code = await toCode(
        context,
        NodeBody.get(NType.scaleAnimation),
        null,
      );
      final res = FormatterTest.format(code);
      if (res) {
  ...
  static Future<bool> runtimeTestDefaultCode(
    ...
    const name = 'ScaleAnimation';
    final nodeBody = NodeBody.get(NType.scaleAnimation);
  ...
  static void testCode() {
    group('ScaleAnimation toCode test', () {
      test(
