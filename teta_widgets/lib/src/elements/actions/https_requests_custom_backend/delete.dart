  ...
  static String toCode(
    ...
    final customHttpRequestExpectedStatusCodeNew =
        customHttpRequestExpectedStatusCode
            ...
            .replaceAll("'", '')
            .replaceAll(" ", '');
    return '''final response =await TetaCMS.instance.httpRequest.delete('$urlNew','$customHttpRequestExpectedStatusCodeNew', <String, dynamic>$mapParamatersString, <String, dynamic>$mapHeadersString);
      List<dynamic>? list;
