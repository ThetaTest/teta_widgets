...
class FActionFirebaseAnalyticsLogShare {
      ...
      builder: (final context) {
        return const AlertDialog(
          ...
          content: SizedBox(
            ...
            height: 400,
            child: Text(
              '(Firebase Analytics- Log Share) will be activated in your released app.',
              style: TextStyle(
                color: Colors.white,
              ),
            ),
  ...
  static String toCode(
    ...
    final firebaseAnalyticsContentTypeNew = firebaseAnalyticsContentType
        ?.toCode(
          loop,
          resultType: ResultTypeEnum.string,
        )
        .replaceAll(' ', '');
    final firebaseAnalyticsItemIdNew = firebaseAnalyticsItemId
        ?.toCode(
          loop,
          resultType: ResultTypeEnum.string,
        )
        .replaceAll(' ', '');
    final firebaseAnalyticsMethodNew = firebaseAnalyticsMethod
        ?.toCode(
          loop,
          resultType: ResultTypeEnum.string,
        )
