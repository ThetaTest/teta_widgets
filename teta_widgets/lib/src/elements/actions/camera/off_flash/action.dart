...
class TACameraOffFlash extends TetaAction {
  TACameraOffFlash({
  ...
  TACameraOffFlash.fromJson(
    final Map<String, dynamic> json,
  ) : super(
          params: const TACameraOffFlashParams(),
          loop: json['loop'] != null
  ...
  @override
  TetaActionType get type => TetaActionType.cameraOffFlash;
