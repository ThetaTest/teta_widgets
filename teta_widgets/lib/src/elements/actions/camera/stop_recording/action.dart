...
class TACameraStopRecording extends TetaAction {
  TACameraStopRecording({
  ...
  TACameraStopRecording.fromJson(
    final Map<String, dynamic> json,
  ) : super(
          params: TACameraStopRecordingParams.fromJson(
  ...
  @override
  TACameraStopRecordingParams get params =>
      super.params as TACameraStopRecordingParams;

  @override
  TetaActionType get type => TetaActionType.cameraStopRecording;
  ...
  String getActionCode(
    ...
    if (${rc.camelCase} != null) {
      if (${rc.camelCase}.value.isRecordingVideo) {
        await ${rc.camelCase}.stopVideoRecording();
      }
    }
    ''';
  }
