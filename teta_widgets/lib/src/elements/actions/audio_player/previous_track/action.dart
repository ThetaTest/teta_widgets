...
class TAAudioPlayerPreviousTrack extends TetaAction {
  TAAudioPlayerPreviousTrack({
  ...
  TAAudioPlayerPreviousTrack.fromJson(
    final Map<String, dynamic> json,
  ) : super(
          params: TAAudioPlayerPreviousTrackParams.fromJson(
  ...
  @override
  TAAudioPlayerPreviousTrackParams get params =>
      super.params as TAAudioPlayerPreviousTrackParams;

  @override
  TetaActionType get type => TetaActionType.audioPlayerPreviousTrack;
  ...
  Future<void> execute(
    ...
    if (variable?.audioController != null) {
      await variable?.audioController?.seekToPrevious();
