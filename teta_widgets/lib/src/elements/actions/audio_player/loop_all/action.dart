...
class TAAudioPlayerLoopAll extends TetaAction {
  TAAudioPlayerLoopAll({
  ...
  TAAudioPlayerLoopAll.fromJson(
    final Map<String, dynamic> json,
  ) : super(
          params: TAAudioPlayerLoopAllParams.fromJson(
  ...
  @override
  TAAudioPlayerLoopAllParams get params =>
      super.params as TAAudioPlayerLoopAllParams;

  @override
  TetaActionType get type => TetaActionType.audioPlayerLoopAll;
