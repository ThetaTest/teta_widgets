...
class TAAudioPlayerNextTrack extends TetaAction {
  TAAudioPlayerNextTrack({
  ...
  TAAudioPlayerNextTrack.fromJson(
    final Map<String, dynamic> json,
  ) : super(
          params: TAAudioPlayerNextTrackParams.fromJson(
  ...
  @override
  TAAudioPlayerNextTrackParams get params =>
      super.params as TAAudioPlayerNextTrackParams;

  @override
  TetaActionType get type => TetaActionType.audioPlayerNextTrack;
