...
class TASupabaseOnDelete extends TetaAction {
  TASupabaseOnDelete({
  ...
  TASupabaseOnDelete.fromJson(
    final Map<String, dynamic> json,
  ) : super(
          params: TASupabaseOnDeleteParams.fromJson(
  ...
  @override
  TASupabaseOnDeleteParams get params =>
      super.params as TASupabaseOnDeleteParams;

  @override
  TetaActionType get type => TetaActionType.supabaseOnDelete;
    ...
    if (client != null) {
      client
        ...
        params.supabaseFrom?.get(
          ...
          .on(SupabaseEventTypes.delete, (final payload) {
