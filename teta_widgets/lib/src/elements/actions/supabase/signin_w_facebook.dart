...
class FASupabaseSignInWithFacebook {
  static Future action(
    ...
    if (client != null) {
      final response = await UserSocialLoginService.instance
          .executeLogin(client.supabaseUrl, LoginProvider.facebook);
      ...
      await Supabase.instance.client.auth.signInWithProvider(Provider.facebook);
    }
  }
