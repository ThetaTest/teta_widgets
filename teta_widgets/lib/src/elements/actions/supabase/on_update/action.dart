...
class TASupabaseOnUpdate extends TetaAction {
  TASupabaseOnUpdate({
  ...
  TASupabaseOnUpdate.fromJson(
    final Map<String, dynamic> json,
  ) : super(
          params: TASupabaseOnUpdateParams.fromJson(
  ...
  @override
  TASupabaseOnUpdateParams get params =>
      super.params as TASupabaseOnUpdateParams;

  @override
  TetaActionType get type => TetaActionType.supabaseOnUpdate;
