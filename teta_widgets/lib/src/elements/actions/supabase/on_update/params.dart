...
class TASupabaseOnUpdateParams implements TetaActionParams {
  const TASupabaseOnUpdateParams({
    required this.supabaseFrom,
    required this.stateName,
    required this.supabaseData,
  });

  const TASupabaseOnUpdateParams.empty()
      : supabaseFrom = null,
        stateName = null,
        supabaseData = const [];

  TASupabaseOnUpdateParams.fromJson(final Map<String, dynamic> json)
