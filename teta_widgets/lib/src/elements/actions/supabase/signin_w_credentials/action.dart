...
class TASupabaseSignInWithCredentials extends TetaAction {
  TASupabaseSignInWithCredentials({
  ...
  TASupabaseSignInWithCredentials.fromJson(
    final Map<String, dynamic> json,
  ) : super(
          params: TASupabaseSignInWithCredentialsParams.fromJson(
  ...
  @override
  TASupabaseSignInWithCredentialsParams get params =>
      super.params as TASupabaseSignInWithCredentialsParams;

  @override
  TetaActionType get type => TetaActionType.supabaseSignInWithCredentials;
