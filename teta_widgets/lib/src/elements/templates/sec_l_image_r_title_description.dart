...
class TempSectionLeftImageRightTitleDescription extends CTemplate {
  String? id;
  String? name = "Row with Image and Title & Body";
  String? type;

  TempSectionLeftImageRightTitleDescription({
    this.id,
    this.name,
    this.type,
  }) {
  ...
  Map<String, dynamic> toJson() {
    ...
    map = {
      ...
      "$id-3": NDynamicRow(
        nid: "$id-3",
        childrenIds: FChildrenIds(childrenIds: ["$id-4", "$id-5"]),
      ).toJson(),
      "$id-4": NImage(
        nid: "$id-4",
      ...
      "$id-5": NContainer(
        nid: "$id-5",
        childrenIds: FChildrenIds(childrenIds: ["$id-6"]),
        fill: FFill(paletteStyle: "xXHoXe56355C+p2"),
      ).toJson(),
      "$id-6": NColumn(
        nid: "$id-6",
        childrenIds: FChildrenIds(childrenIds: ["$id-7", "$id-8"]),
