...
class PaddingsState extends State<TextControl> with AfterLayoutMixin {
  ...
  FutureOr<void> afterFirstLayout(final BuildContext context) {
    try {
      setState(() {
        inputController.text = widget.value.getValue(
          context,
          forPlay: false,
        );
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<DeviceModeCubit, DeviceState>(
      listener: (context, device) {
        if (inputController.text !=
            widget.value.getValue(context, forPlay: false)) {
          inputController.text = widget.value.getValue(context, forPlay: false);
        }
      },
                    ...
                    CMultiLinesTextField(
                      ...
                      callBack: (final value) {
                        ...
                        widget.value.updateValue(
                          inputController.text.replaceAll(r'\', r'\\'),
                          context,
                  ...
                  Padding(
                    ...
                    child: CDropdownCustom<String>(
                      ...
                      onChange: (final newValue) {
                        ...
                        widget.value.datasetLength = (dataset.getMap.isNotEmpty
                                ? dataset.getMap
                                : <dynamic>[])
                            .length
                            .toString();
