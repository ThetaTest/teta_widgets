...
class GoogleMapsControl extends StatefulWidget {
  const GoogleMapsControl({
    required this.node,
    required this.value,
    required this.page,
    required this.title,
  ...
  @override
  GoogleMapsControlState createState() => GoogleMapsControlState();
}

class GoogleMapsControlState extends State<GoogleMapsControl> {
  int? nodeId;
  bool? isUpdated;
  String? text;
            ...
            if (widget.value.type == FTextTypeEnum.param)
              CDropdown(
                ...
                items: widget.page.params
                    .where(
                      (final element) =>
                          element.type == VariableType.googleMapsController,
                    )
                    .map((final e) => e.name)
                    .toList(),
