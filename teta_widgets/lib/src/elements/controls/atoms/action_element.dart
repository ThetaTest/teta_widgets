                ...
                Column(
                  ...
                  children: [
                      ...
                      control: CDropdown(
                        value: widget.page.states
                          ...
                          element.type ==
                            ...
                            .toList()
                            .indexWhere(
                              (final e) => e == widget.element.stateName2,
                        ) !=
                            -1
                    ...
                    if(ActionGoogleMaps.updateLiveLocation ==
                      ...
                      descriptionControlWidget(
                        description: 'Each time a new location is streamed it will be stored here.',
                        control: CDropdown(
                          value: widget.page.states
                              .where(
                                (final element) =>
                            element.type ==
                              ...
                              .toList()
                              .indexWhere(
                                (final e) => e == widget.element.stateName3,
                          ) !=
                              -1
                        ...
                        control: CDropdown(
                          value: widget.page.states
                            ...
                            element.type ==
                              ...
                              .toList()
                              .indexWhere(
                                (final e) => e == widget.element.stateName4,
                          ) !=
                              -1
