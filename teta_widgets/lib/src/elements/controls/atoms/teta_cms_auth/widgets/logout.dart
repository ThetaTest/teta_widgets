...
import '../../../../actions/teta_cms/auth/logout/action.dart';
import '../../../../actions/teta_cms/auth/logout/params.dart';

class TetaCmsLogoutControl extends StatefulWidget {
  const TetaCmsLogoutControl({
    required this.action,
    required this.onParamsChanged,
    final Key? key,
  }) : super(key: key);

  final TATetaCMSLogout action;
  final Function(TATetaCMSLogoutParams params) onParamsChanged;

  @override
  State<TetaCmsLogoutControl> createState() => _TetaCmsLogoutControlState();
}

class _TetaCmsLogoutControlState extends State<TetaCmsLogoutControl> {
  ...
  void initState() {
    ...
    paramsToSend = widget.action.params.paramsToSend ?? <String, dynamic>{};
    try {
