...
import 'package:teta_widgets/src/elements/actions/supabase/signin_w_credentials/params.dart';
...
class SupabaseSigninWCredentialsControl extends StatefulWidget {
  const SupabaseSigninWCredentialsControl({
    super.key,
    required this.action,
    required this.onParamsChanged,
  });

  final TASupabaseSignInWithCredentials action;
  final Function(TASupabaseSignInWithCredentialsParams params) onParamsChanged;

  @override
  State<SupabaseSigninWCredentialsControl> createState() =>
      SupabaseSigninWCredentialsControlState();
}

class SupabaseSigninWCredentialsControlState
    extends State<SupabaseSigninWCredentialsControl> {
  String? pageToOpen;
