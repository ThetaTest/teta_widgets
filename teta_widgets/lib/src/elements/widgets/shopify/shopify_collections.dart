...
class WShopifyCollections extends StatefulWidget {
  final CNode node;
  final String? nid;
  final String? parent;
  final CNode? child;
  ...
  @override
  _WShopifyCollectionsState createState() => _WShopifyCollectionsState();
}

class _WShopifyCollectionsState extends State<WShopifyCollections> {
      ...
      child: _isLoading
          ...
          : ListView.builder(
              ...
              itemBuilder: (_, int index) => widget.child != null
                  ...
                  : collectionThumbnail(collections[index]),
            ),
    );
  }
