...
final stripeShippingBuilder = IntrinsicStates(
...
class StripeShippingBuilderBody extends NodeBody {
  @override
  ...
  Future<String> toCode(
    ...
    final int? loop,
      ...
      CS.defaultWidgets(
        ...
        node,
        pageId,
        StripeShippingBuilderCodeTemplate.toCode(context, this, child),
        loop ?? 0,
      );
}
