...
import 'package:mobile_editor/src/elements/widgets/shopify/shopify_user.dart';
import 'package:mobile_editor/src/models/dataset.dart';
import 'package:mobile_editor/src/models/variable.dart';

const globalType = "ShpUser";
const global_name = "Shopify User";

class ShpUserIntrinsicStates extends IntrinsicStates {
...
class NShopifyUser extends CNode {
