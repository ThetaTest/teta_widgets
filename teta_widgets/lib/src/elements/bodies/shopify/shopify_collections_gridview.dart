...
const globalType = "ShpCollcts";
const global_name = "Shopify Collections";

class ShpCollctsIntrinsicStates extends IntrinsicStates {
...
class NShopifyCollections extends CNode {
  ...
  static NShopifyCollections fromJson(
    Map<String, dynamic> doc,
    String prjId,
    String pageId,
    BuildContext context,
  ) {
    return NShopifyCollections(
      nid: doc[DBKeys.id],
