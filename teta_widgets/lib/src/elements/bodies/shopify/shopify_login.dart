...
import 'package:mobile_editor/src/elements/widgets/shopify/shopify_login.dart';
import 'package:mobile_editor/src/models/dataset.dart';
import 'package:mobile_editor/src/models/variable.dart';

//ignore: must_be_immutable
class NShopifyLogin extends CNode {
  ...
  String? displayName = "Shopify Login";
  ...
  @override
  String toString() => 'ShpLogin { nid: $nid, value: $value }';
  ...
  Widget toWidget({
    ...
    required bool forPlay,
      ...
      WShopifyLogin(
        ...
        btnValue: btnValue!,
        btnSizes: btnSizes!,
        btnMargins: btnMargins!,
        btnPaddings: btnPaddings!,
        btnBorderRadius: btnBorderRadius!,
        btnFill: btnFill!,
        btnTextFill: btnTextFill!,
  ...
  static NShopifyLogin fromJson(String id,
    Map<String, dynamic> doc,
    String prjId,
    String pageId,
    BuildContext context,
  ) {
    return NShopifyLogin(
      nid: doc['id'],
      ...
      btnValue: FTextTypeInput().fromJson(doc['btnValue']),
  ...
  mergeJson(
    ...
    map.keys.forEach((key) {
      ...
      if (key == 'btnValue') btnValue = FTextTypeInput().fromJson(map[key]);
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'btnValue': (btnValue != null)
          ? btnValue!.toJson()
          : FTextTypeInput(type: FTextTypeEnum.text, value: 'Click Here')
              .toJson(),
      ...
      'btnSizes': (btnSizes != null)
          ? btnSizes!.toJson()
          : FSize(sizes: [
              SizeElement(sizes: ["maxe", "48"], unit: SizeUnit.pixel),
