...
/// Generates the code for AudioPlayerProgressIndicator widget
class AudioPlayerProgressIndicatorTemplate {
  ...
  static void testCode() {
    group('AudioPlayerProgressIndicatorTemplate toCode test', () {
      test(
        'AudioPlayerProgressIndicatorTemplate: default code',
        () {
