...
import 'package:mobile_editor/src/elements/widgets/shopify/shopify_product_recommendations_horizontal.dart';
import 'package:mobile_editor/src/models/dataset.dart';
import 'package:mobile_editor/src/models/variable.dart';

const globalType = "ShpPrdRecommendations";
const global_name = "Shopify Product Recommendations";

class ShpPrdRecommendationsIntrinsicStates extends IntrinsicStates {
  final String nodeIcon = "w_icons/products_suggestion.png";
...
class NShopifyProductRecommendations extends CNode {
  ...
  NShopifyProductRecommendations({
    this.nid,
    this.child,
    this.childrenIds,
    this.prjId,
  ...
  static NShopifyProductRecommendations fromJson(
    Map<String, dynamic> doc,
    String prjId,
    String pageId,
    BuildContext context,
  ) {
    return NShopifyProductRecommendations(
      nid: doc[DBKeys.id],
  ...
  String toCode(BuildContext context) {
    ...
    return """
      TShopifyProductRecommendations(
        child: $strChild
      ),
    """;
  }
