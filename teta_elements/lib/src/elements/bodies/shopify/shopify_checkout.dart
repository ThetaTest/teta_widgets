...
import 'package:mobile_editor/src/elements/widgets/shopify/shopify_checkout.dart';
import 'package:mobile_editor/src/models/dataset.dart';
import 'package:mobile_editor/src/models/variable.dart';

const globalType = "ShpCheckout";
const global_name = "Shopify Checkout";

class ShpCheckoutIntrinsicStates extends IntrinsicStates {
...
class NShopifyCheckout extends CNode {
  ...
  static NShopifyCheckout fromJson(
    Map<String, dynamic> doc,
    String prjId,
    String pageId,
    BuildContext context,
  ) {
    return NShopifyCheckout(
      nid: doc[DBKeys.id],
